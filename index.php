...
<head>
     ...
     <title>Royal Cars Workshop</title>
     <!--
...
-->
     ...
     <link rel="shortcut icon" type="image/x-icon" href="images/royallogo.png">
     <!-- MAIN CSS -->
          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-4 col-sm-5">
                         <p>Atasi masalah kendaraan anda bersama Royal Cars Workshop</p>
                    </div>

                    <div class="col-md-8 col-sm-7 text-align-right">
                         <span class="phone-icon"><i class="fa fa-phone"></i> 089644412720</span>
                         <span class="date-icon"><i class="fa fa-calendar-plus-o"></i> 08.00 - 17:00 (Setiap Hari)</span>
                    </div>
     ...
     <section class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.php" class="navbar-brand">ROYAL CAR</a>
               </div>
                    ...
                    <div class="col-md-12 col-sm-12">
                         ...
                         <form id="appointment-form" role="form" method="post" action="pages/proses_pendaftaran.php">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   ...
                                   <div class="col-md-6 col-sm-6">
                                        <label for="email">Tanggal Boking</label>
                                        <input type="date" class="form-control" id="email" name="tgl_boking" required="">
                                   </div>

                                   <div class="col-md-6 col-sm-6">
                                        <label for="email">Jam Boking</label>
               ...
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         <div class="about-info">
                              ...
                              <div class="wow fadeInUp" data-wow-delay="0.8s">
                                   <p>Royal cars workshop adalah sebuah usaha yang melayani jasa service mobil. Royal cars
                                        workshop memiliki reputasi yang bagus dalam memberikan layanan perbaikan dan perawatan
                                        mobil yang berkualitas tinggi kepada pelanggan. Terletak di lokasi yang strategis, royal cars
                                        workshop memiliki fasilitas yang lengkap, termasuk mesin-mesin modern, peralatan canggih,
                                        dan teknisi berpengalaman yang siap membantu Anda merawat dan memperbaiki kendaraan
                                        Anda. Royal cars workshop mengkhususkan diri dalam berbagai jenis layanan, mulai dari
                                        perbaikan mesin hingga perawatan rutin </p>
                              </div>
                              <figure class="profile wow fadeInUp" data-wow-delay="1s">
                                   <figcaption>
                                        <h3>"Bengkel Ini Bukan Cuma Soal Baut dan Mur, Tapi Juga Senyumanmu!"</h3>
                                   </figcaption>
                              </figure>
                         </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb">
                              ...
                              <div class="contact-info">
                                   <p><i class="fa fa-phone"></i> 089644412720</p>
                                   <p><i class="fa fa-envelope-o"></i> <a href="#">royalcarsworkshop@company.com</a></p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb">
                              <div class="opening-hours">
                                   ...
                                   <p>Senin - Minggu <span>08:00 - 17:00</span></p>
                              </div>
                         </div>
                    </div>
