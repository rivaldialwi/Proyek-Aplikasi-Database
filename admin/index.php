...
<head>
    ...
    <title>Admin Panel - Royal Cars Workshop</title>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">Master Data</li><!-- /.master data -->
                    <li>
                        <a href="index.php?p=user"> <i class="menu-icon ti-user"></i>Admin </a>
                    </li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="../images/royallogo.png" width="50" height="40" alt="Logo"></a>
